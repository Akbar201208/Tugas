...
public class TesGuru {
    public static void main(String[] args) {
       ...
       pasha.id = 1;
       pasha.nama ="Pashatania Fitri Indah Lestari";
       ...
       diaur.id = 2;
       diaur.nama ="Daiur Rahman";
       diaur.mapel = "Penjaskes";
       diaur.alamat = "Malang";
       ...
       agus.id = 5;
       agus.nama ="Bagus Arifin";
       agus.mapel = "Informatika";
       agus.alamat = "Bogor";
       System.out.println("Ini Data Pak Agus");
       System.out.println(agus.id);
       System.out.println(agus.nama);
       System.out.println(agus.mapel);
       System.out.println(agus.alamat);
    }
}
